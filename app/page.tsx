    ...
    <main className="flex-1 w-full max-w-full overflow-x-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-14 md:py-20 w-full overflow-hidden">
        ...
        {featuredProducts.length === 0 ? (
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-5 w-full min-w-0">
      ...
      <section className="bg-neutral-900 text-white py-14 md:py-20 px-4 sm:px-6 md:px-10 w-full overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center w-full min-w-0">
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 pt-4 border-t border-neutral-800">
              <div>
                <span className="text-base sm:text-lg font-serif font-bold text-brand-gold-light">01</span>
                <h4 className="text-xs sm:text-sm font-semibold text-neutral-200 mt-0.5">Submit Details</h4>
                <p className="text-xs text-neutral-400 mt-0.5">Share your measurements and inspiration notes.</p>
              </div>
              <div>
                <span className="text-base sm:text-lg font-serif font-bold text-brand-gold-light">02</span>
                <h4 className="text-xs sm:text-sm font-semibold text-neutral-200 mt-0.5">Consult on WhatsApp</h4>
                <p className="text-xs text-neutral-400 mt-0.5">Refine fabrics and styling with our team.</p>
              </div>
              <div>
                <span className="text-base sm:text-lg font-serif font-bold text-brand-gold-light">03</span>
                <h4 className="text-xs sm:text-sm font-semibold text-neutral-200 mt-0.5">Tailored &amp; Delivered</h4>
                <p className="text-xs text-neutral-400 mt-0.5">Precision cut and shipped worldwide.</p>
              </div>
            </div>
            ...
            <div className="pt-2">
              <Link
                href="/custom-order"
                className="inline-block w-full sm:w-auto text-center rounded-full bg-white text-neutral-900 px-8 py-3.5 text-sm font-medium hover:bg-neutral-100 transition shadow-sm"
              >
