...
export default function SizeChartPage() {
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 md:px-10 py-12 md:py-20 space-y-12 w-full max-w-full overflow-x-hidden min-w-0">
      ...
      <div className="bg-neutral-50/70 dark:bg-neutral-900/60 p-6 sm:p-8 rounded-2xl border border-neutral-200/80 dark:border-neutral-800 shadow-sm space-y-6 transition-colors">
        <div>
      ...
      <div className="space-y-6 pt-4">
        <h2 className="font-serif text-2xl font-bold text-neutral-900 dark:text-neutral-50 text-center sm:text-left">
          How to Measure Your Body
        </h2>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="p-6 rounded-xl bg-white dark:bg-neutral-900/80 border border-neutral-200/70 dark:border-neutral-800 shadow-sm space-y-2 transition-colors">
            <div className="flex items-center gap-2">
              <span className="font-serif font-bold text-brand-accent text-lg">01.</span>
              <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 text-sm">Bust / Chest</h3>
            </div>
          ...
          <div className="p-6 rounded-xl bg-white dark:bg-neutral-900/80 border border-neutral-200/70 dark:border-neutral-800 shadow-sm space-y-2 transition-colors">
            <div className="flex items-center gap-2">
              <span className="font-serif font-bold text-brand-accent text-lg">02.</span>
              <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 text-sm">Natural Waist</h3>
            </div>
            <p className="text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed font-light">
          ...
          <div className="p-6 rounded-xl bg-white dark:bg-neutral-900/80 border border-neutral-200/70 dark:border-neutral-800 shadow-sm space-y-2 transition-colors">
            <div className="flex items-center gap-2">
              <span className="font-serif font-bold text-brand-accent text-lg">03.</span>
              <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 text-sm">Hips</h3>
            </div>
            <p className="text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed font-light">
          ...
          <div className="p-6 rounded-xl bg-white dark:bg-neutral-900/80 border border-neutral-200/70 dark:border-neutral-800 shadow-sm space-y-2 transition-colors">
            <div className="flex items-center gap-2">
              <span className="font-serif font-bold text-brand-accent text-lg">04.</span>
              <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 text-sm">Dress / Garment Length</h3>
            </div>
            <p className="text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed font-light">
      ...
      <div className="bg-neutral-900 dark:bg-[#121215] text-white rounded-2xl p-8 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-sm border border-transparent dark:border-neutral-800 transition-colors">
        ...
        <Link
          href="/custom-order"
          className="rounded-full bg-white text-neutral-900 hover:bg-neutral-100 px-8 py-3.5 text-xs font-semibold transition whitespace-nowrap"
        >
